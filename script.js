...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const metadata = [
        { title: 'Slowdive - Souvlaki', desc: "I love Slowdive and was very happy to find this CD in person! My favorite track from this album is 'When the Sun Hits.' Give it a listen.", youtube: '9AS_6jvUJ9Q', start: 60 },
        { title: 'Orbiting Human Circus - Quartet Plus Two', desc: 'The Orbiting Human Circus along with The Music Tapes are certainly a unique sound and I love them for it! This was a great find in person after I tried to order it online. My favorite track is "Let’s Face the Music!" If you want to listen to something probably out of your comfort zone, they are for you!', youtube: 'MKYY0IlTMw4', start: 1 },
        ...
        { title: 'Duster - Stratosphere', desc: 'I would say Duster is definitely a band where you have to get familiar with their music. Stratosphere is their most popular album (I also have it on cassette). My favorite track is "Earth Moon Transit."', youtube: 'QJkFQwZ5q0w', start: 120 },
        { title: 'Molchat Doma - Etazhi', desc: 'Definitely an album where you have to be in the know to be able to find it. A very worthwhile listen if you want to expand your taste! My favorite track is "Sudno (Boris Ryzhy)."', youtube: 'sv9vA5Uu6bA', start: 60 },
        { title: 'Nirvana - In Utero', desc: 'I am a MASSIVE Nirvana fan and I don’t think I’ll ever have a 100% favorite album, but this might just be it. This album was one of the first that I ever bought. My favorite track would be "Serve the Servants," the first track on the album!', youtube: 'vabnZ9-ex7o', start: 30 },
        { title: 'GingerBee - Our Skies Smile', desc: 'GingerBee is a smaller band that I somehow found on Spotify and then became mutuals with one of the band members on Instagram. Such a chill, cool band that I want to see in concert hopefully in the future. As an EP, it does have a shorter track list and my favorite track would have to be the title track "Our Skies Smile!"', youtube: 'dQw4w9WgXcQ', start: 15 },
        { title: 'Neutral Milk Hotel - In the Aeroplane Over the Sea', desc: 'I would say this is one of the most incel albums in my collection (besides the Radiohead and Fight Club motion picture score), but it is still a great album if you ignore the somewhat strange messages. My favorite track would be the title track "In the Aeroplane Over the Sea."', youtube: 'n7bM2eFfQZ8', start: 75 },
        { title: 'Malice Mizer - Best Songs', desc: 'Malice Mizer is a Japanese band that was active from 1992–2001. They were one of the most popular visual kei bands ever in the scene. As with many bands from that time, there was apparent drama and so on. As much as I want other albums from them, as they are an older band from Japan, they are incredibly hard to find in person or online for a good price. My favorite track that is featured on this collection would be "Au Revoir."', youtube: 'QwZk6yZ9QwA', start: 60 },
        { title: 'American Football - American Football (LP2)', desc: 'Not my favorite American Football album, but others are harder to find! My favorite track from this LP would have to be "I Need a Drink (or Two or Three)."', youtube: 'QwKjQwKjQwK', start: 120 },
        { title: 'Title Fight - Shed', desc: 'Title Fight is a very unassuming band where if you listen to their most popular song, you might be led astray with what you think their other music sounds like. But I must say, off this album my favorite (and it’s popular for a reason) would be "Safe In Your Skin."', youtube: 'QwKjQwKjQwJ', start: 90 },
        { title: 'Nirvana - Bleach', desc: 'Yes, yes, another Nirvana album—wrap it up, but listen. Ok, I don’t have a real reason, I just love them. Bleach for some reason is pretty underrated compared to their other albums and I really don’t know why. If I had to guess, it would be because I think it is their most gritty album, but that is what makes it so great. My favorite track would have to be "Love Buzz."', youtube: 'QwKjQwKjQwL', start: 30 }
    ];
    ...
    function updatePage() {
        ...
        if (flipbookTitle && flipbookDesc) {
            ...
            if (ytFrame && meta.youtube) {
                // Use YouTube embed with autoplay, mute, and start time for compatibility
                const startParam = meta.start ? `&start=${meta.start}` : '';
                ytFrame.src = `https://www.youtube.com/embed/${meta.youtube}?autoplay=1&mute=1&controls=1${startParam}&origin=${location.origin}`;
            } else if (ytFrame) {
                ytFrame.src = '';
            }
        }
